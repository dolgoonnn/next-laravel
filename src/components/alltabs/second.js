            ...
            <div className="font-normal mt-10 font-gordita text-center sm:text-left">
                 <div className="bcm-white font-gordita text-bc-A1A text-[17px] leading-8">
                    <p>
                        ...
                        <br/>
                        <br/>
                        <strong>Залуус хамтдаа нийлж санаагаа төсөл болгон амьдруулах, бизнес болгон томруулж өөрсдөө эзэмших</strong>, үр шимийг нь өөрсдөө хүртэх боломжийг Web 3.0 технологи бидэнд олгож байна.
                        <br/>
                        <br/>
